...
${RELATED_TAB_NEW_BUTTON_WEBELEMENT}                    xpath\=(//div[@class\="listWrapper"])[POSITION]//button[@name\="New"]
${ENTER_APEX_CODE_CONSOLE_WEBELEMENT}                   xpath\=//div[@id\='panel-1184-body']/div[1]/div[1]/textarea[1]
${SELECT_PIPELINE_VIEW}                                 xpath\=//select[@class\="slds-select filterDropdown"]